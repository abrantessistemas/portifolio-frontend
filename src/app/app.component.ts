...
export class AppComponent {
  ...
  constructor(private configService: ConfigService,
    ...
    this.authenticationService.authentication.subscribe(jwt => {
      this.buildMenu();
    });
  }
  ...
  buildMenu() {
    ...
    this.navigationService.items.push({ type: 'link', label: 'Dashboard', route: '/', icon: icDashboard });

    if (this.authenticationService.isUserInRole('MASTER')) {
